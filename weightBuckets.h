...
cout << "max_weight: " << max_weight << endl;
		...
		for(v_w = 1; v_w <= max_weight; v_w++)
		{
			ptr_to_out_vertices_of_weight[v_w] = ptr_to_in_vertices_of_weight[v_w]; // all vertices are out
		}
...
#ifdef debug_mode
cout << 4.22 << endl;
cout << ptr_to_out_vertices_of_weight[v_w] << endl;
cout << v_w << ", " << qtr_to_out_vertices_of_weight[v_w] << endl;
#endif
...
*/
	...
	{
#ifdef debug_mode
if(!is_out_vertex_in_bucket_of_weight(v, vertices[v].get_weight()))
{
	cout << "vertex: " << v << ", weight: " << vertices[v].get_weight() << endl;
	cout << "in weightBucket.h, about to add " << v << " into cover, but not in out-bucket" << endl;
	cout << "vertex: " << v << ", weight: " << vertices[v].get_weight() << endl;
	cout << "its index: " << index_in_v_ascending_weight_array[v] << endl;
	cout << "before adding in weightBucket.h" << endl;
	cout << "in begin weight: " << vertices[v].get_weight() << " " << ptr_to_in_vertices_of_weight[vertices[v].get_weight()] << endl;
	cout << "out begin weight: " << vertices[v].get_weight() << " " << ptr_to_out_vertices_of_weight[vertices[v].get_weight()] << endl;
	cout << "in begin weight: " << vertices[v].get_weight() + 1 << " " << ptr_to_in_vertices_of_weight[vertices[v].get_weight() + 1] << endl;
	cout << "out begin weight: " << vertices[v].get_weight() + 1 << " " << ptr_to_out_vertices_of_weight[vertices[v].get_weight() + 1] << endl;
	cout << "in weightBucket.h, having been added into cover, but not in out-bucket" << endl;
}
#endif
...
#ifdef debug_mode
if(!is_in_vertex_in_bucket_of_weight(v, vertices[v].get_weight()))
{
	cout << "vertex: " << v << ", weight: " << vertices[v].get_weight() << endl;
	cout << "its index: " << index_in_v_ascending_weight_array[v] << endl;
	cout << "after adding in weightBucket.h" << endl;
	cout << "in begin weight: " << vertices[v].get_weight() << " " << ptr_to_in_vertices_of_weight[vertices[v].get_weight()] << endl;
	cout << "out begin weight: " << vertices[v].get_weight() << " " << ptr_to_out_vertices_of_weight[vertices[v].get_weight()] << endl;
	cout << "in begin weight: " << vertices[v].get_weight() + 1 << " " << ptr_to_in_vertices_of_weight[vertices[v].get_weight() + 1] << endl;
	cout << "out begin weight: " << vertices[v].get_weight() + 1 << " " << ptr_to_out_vertices_of_weight[vertices[v].get_weight() + 1] << endl;
	cout << "in weightBucket.h, having been added into cover, but not in in-bucket" << endl;
}
#endif
	}
	...
	LL vertex_outside_cover_of_smallest_weight_then_time_stamp(HugeInt* time_stamp)
	{
		LL v_w = 0;
		LL best_v = 0;
...
cout << "filter out " << v << endl;
	...
	void show_weight_bucket()
	{
		...
		for(LL v_w = 0; v_w <= max_weight; v_w++)
		{
			...
			cout << "vertex at the beginning of an in-section: " << v_ascending_weight_array[ptr_to_in_vertices_of_weight[v_w]] << endl;
			...
			cout << "vertex at the beginning of an out-section: " << v_ascending_weight_array[ptr_to_out_vertices_of_weight[v_w]] << endl;
